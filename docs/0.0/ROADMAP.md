...
| 2 | [PR-030](../../prs/PR-030-close-vision-prompt-shipping-decision.md) | Close the vision-prompt shipping decision (no ranking — see note) | Tier-1 | `[x]` | PR-029, PR-032, PR-026 |
